...
$sql= "INSERT INTO USUARIO(username,password,rol,nombre,apellido ) VALUES ('".$username."','".$password."',2,'".$nombre."','".$apellido."')";
...
<hr/>
<?php
$stid = oci_parse($conn, 'SELECT username,nombre,apellido,rol FROM usuario WHERE rol=2');
if (!$stid) {
    $e = oci_error($conn);
    trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
}
...
<nav >
                    <ul class="sf-menu" id="nav">
                        <li ><a href="r2_crear.php">Crear Nuevo</a></li>
